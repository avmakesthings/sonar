Shader "Wireframe Artist/DirectX11/Standard" {
	Properties {
		// Wire
	...
	CGINCLUDE
		...
		// The following are defined to avoid laggy GUI and to shorten compilation time
		// This decreases performance very slightly only if AA or emission should be disabled
		// But since this is a DirectX 11 shader, this shouldn't matter too much 
		#define _EMISSION 
		#define _AA_ON
	ENDCG
	SubShader {
		...
		Pass{
			...
			#pragma shader_feature WFA_TWOSIDED
	...
	FallBack "Wireframe Artist/Standard"
