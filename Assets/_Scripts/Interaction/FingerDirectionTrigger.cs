    ...
    */
    ...
    private void OnDrawGizmos () {
      if (ShowGizmos && HandModel != null && HandModel.IsTracked) {
        ...
        Utils.DrawCone(finger.TipPosition.ToVector3(), fingerDirection, OnAngle, finger.Length*500, innerColor);
        Utils.DrawCone(finger.TipPosition.ToVector3(), fingerDirection, OffAngle, finger.Length*500, LimitColor);
        Gizmos.color = DirectionColor;

        Vector fingerDir = finger.Direction;
        //print(fingerDir +"direction");
        //print(finger.TipPosition + "tip");
        Vector3 newTipPosition = finger.TipPosition.ToVector3() + new Vector3(0,10,0);
        Gizmos.DrawRay(finger.TipPosition.ToVector3(), finger.Direction.ToVector3());
